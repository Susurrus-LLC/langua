...
describe('Button', () => {
  ...
  it('renders accurately with various props and children', () => {
    ...
    expect(tree).toMatchInlineSnapshot(`
      <button
        className="Button-btn-0-2-1 Button-success-0-2-3"
        role="button"
        type="submit"
      >
        Submit
    ...
    expect(tree).toMatchInlineSnapshot(`
      <button
        className="Button-btn-0-2-1 Button-danger-0-2-4"
        role="button"
        type="reset"
      >
        Reset
    ...
    expect(tree).toMatchInlineSnapshot(`
      <button
        className="Button-btn-0-2-1 Button-neutral-0-2-2"
        role="link"
        type="button"
      >
        Link
    ...
    expect(tree).toMatchInlineSnapshot(`
      <button
        className="Button-btn-0-2-1 Button-small-0-2-6"
